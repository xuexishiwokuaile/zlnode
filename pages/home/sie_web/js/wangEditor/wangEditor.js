                    ...
                    if (fileList.length) {
                        ...
                        for (var i = 0; i < fileList.length; i++) {
                            var processResult_uploadImg = function(picId){
                                console.log(picId);
                                var videoUrl = "/one/downloadFile.spe?dtype=PostgresXL&mode=html&fileid="+picId;
                                console.log(videoUrl);
                                var video = '<video style="width:64rem;height:48rem;" controls=""><source src="'+videoUrl+'" type="video/mp4"></video>';
                                editor.txt.append(video);
                            };
                            uploadToDatabase(fileList[i],processResult_uploadImg,"databaseType=Sqldb")
                        }
                    }
...
Text.prototype = {
    ...
    _pasteHandle: function _pasteHandle() {
        ...
        $textElem.on('paste', function (e) {
            ...
            //上传视频
            var uploadVideo = editor.uploadImg;
            uploadVideo.uploadVideo(pasteFiles);
        });
    },
